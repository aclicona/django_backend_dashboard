<template>
  <div class="sticky top-0 z-40 bg-gray-100">
    <div
      class="
        w-full
        h-14
...
import { ME_USER } from '../graph/user'

const graphql = inject('graphql')
...
const getUserInfo = async () => {
  const { me } = await graphql.request(ME_USER, {})
  if (me) {
